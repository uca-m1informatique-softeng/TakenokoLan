...
import ressources.CarteObjectifParcelle;
import ressources.CartesObjectifs;
import ressources.Parcelle;
...
public class LaPiocheObjectifsParcelles {
    ...
    private ArrayList<ressources.CartesObjectifs> pioche = new ArrayList<>();
