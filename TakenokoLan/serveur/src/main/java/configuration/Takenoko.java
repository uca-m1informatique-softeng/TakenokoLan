...
import entites.Panda;
import moteur.Terrain;
import org.springframework.context.annotation.Configuration;
import pioches.LaPiocheParcelle;
import pioches.LesPiochesObjectif;
import utilitaires.StatistiqueJoueur;
...
public class Takenoko {
    ...
    public static final Logger LOGGER = Logger.getLogger(configuration.Takenoko.class.getCanonicalName());
