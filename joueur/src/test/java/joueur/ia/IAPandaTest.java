...
public class IAPandaTest {
    ...
    public void IAPandaTest1() throws TricheException {
        ...
        //de type panda
        Assert.assertTrue(verifPanda(feuilleJoueur.getMainObjectif().get(0)));
    }
    ...
    public void IAPandaTest2() throws TricheException {
        ...
        doAnswer(
                new Answer() {
                    @Override
                    public Object answer(InvocationOnMock invocation) throws Throwable {
                        terrain.changements(p2, feuilleJoueur);
                        return null;
                    }
    ...
    public void IAPandaTest3() throws TricheException {
        ...
        doAnswer(
                new Answer() {
                    @Override
                    public Object answer(InvocationOnMock invocation) throws Throwable {
                        terrain.changements(p3, feuilleJoueur);
                        return null;
                    }
    ...
    public void IAPandaTest6() throws TricheException {
        ...
        Assert.assertEquals(4, feuilleJoueur.getPointsBot());
    }
}
